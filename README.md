...
An AI-powered care home management platform I built for North Senior Care during my internship, addressing the limitations of their existing system. Pitched the idea to management, got it approved, and worked directly with carers and managers to understand what actually needed to improve.
...
| Layer | Technology |
|-------|------------|
| Database | PostgreSQL — 10+ relational tables using Prisma as the ORM |
| Backend | Node.js / TypeScript — RESTful API with OpenAI integration |
| Frontend | React / Next.js — role-based interface, custom charts, calendar view and smooth animations using Framer Motion + Tailwind CSS |
| Infrastructure | Docker / Google Cloud — containerised and hosted on GCP |
